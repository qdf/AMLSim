...
python3 scripts/transaction_graph_generator.py aml_prop.ini outputs/accounts.csv degree.csv paramFiles/transactionType.csv paramFiles/alertPatterns.csv
echo "DONE"
...
python3 scripts/move_files_to_output_dir.py
